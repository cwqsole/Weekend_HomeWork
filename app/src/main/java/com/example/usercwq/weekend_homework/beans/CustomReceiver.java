...
import com.example.usercwq.weekend_homework.MainActivity;
import com.example.usercwq.weekend_homework.MeiNvActivity;
...
public class CustomReceiver extends BroadcastReceiver {
    ...
    private void sendNotification(Context context, String msg) {
        ...
        try {
            ...
            //getString optString 都是通过key 获取value
            //getstring如果json没有这个键就崩了
            //extrasJson.getString("eee");
        ...
        if ("1".equals(data)) {
            ...
            intent = new Intent(context, WangFragment.class);
        }else{
            intent = new Intent(context, MeiNvActivity.class);
        }
        intent.putExtra("url",url);
        //广播启动activity需要设置flag
